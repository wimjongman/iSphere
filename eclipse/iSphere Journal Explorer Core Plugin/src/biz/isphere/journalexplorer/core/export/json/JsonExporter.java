...
public class JsonExporter {
    ...
    public String execute(Shell shell, JournalEntries journalEntries, String file) {
    ...
    private String performExportToJson(JournalEntries journalEntries, String file) {
        ...
        try {
            ...
            gson.toJson(journalEntries, writer);
            writer.flush();
            writer.close();
            return file;
        } catch (Exception e) {
