...
public class SpooledFileFilter {
	...
	public String getFilterString() {
		...
		if (user == null) filterString.append("*/");
		else filterString.append(user + "/");
		if (outputQueue == null) filterString.append("*/");
		else filterString.append(outputQueue + "/");
		if (outputQueueLibrary == null) filterString.append("*/");
		else filterString.append(outputQueueLibrary + "/");
		if (userData == null) filterString.append("*/");
		else filterString.append(userData + "/");
		if (formType == null) filterString.append("*/");
		else filterString.append(formType + "/");
