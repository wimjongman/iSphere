...
public class SearchExec {
	...
	private class Search extends Job {
		...
		private void getStatus() {
			...
			try {
				preparedStatementSelect = _jdbcConnection.prepareStatement("SELECT XSCNT, XSCNL FROM " + iSphereLibrary + _separator + "FNDSTRS WHERE XSHDL = ?");
		...
		private void cancelJob() {
			...
			try {
				preparedStatementUpdate = _jdbcConnection.prepareStatement("UPDATE " + iSphereLibrary + _separator + "FNDSTRS SET XSCNL = '*YES' WHERE XSHDL = ?");
