		...
		try {
			...
			BindingDirectoryEditorInput editorInput = 
				new BindingDirectoryEditorInput(
						"biz.isphere.bindingdirectoryeditor.BindingDirectoryEditor",
						as400,
						jdbcConnection,
						host,
						library,
			...
			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(editorInput, "biz.isphere.bindingdirectoryeditor.BindingDirectoryEditor");
