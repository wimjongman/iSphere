		...
		try {
			...
			ProgramCallDocument pcml = 
				new ProgramCallDocument(
						_as400, 
						"de.taskforce.isphere.messagefileeditor.QMHRTVM", 
						this.getClass().getClassLoader());
			pcml.setValue("QMHRTVM.messageFile", 
					getStringWithFixLength(_messageFile, 10) + 
					getStringWithFixLength(_library, 10));
