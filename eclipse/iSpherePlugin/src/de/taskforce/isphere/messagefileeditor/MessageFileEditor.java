		...
		try {
			...
			MessageFileEditorInput editorInput = 
				new MessageFileEditorInput(
						"de.taskforce.isphere.messagefileeditor.MessageFileEditor",
						as400,
						host,
						library,
						messageFile,
			...
			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(editorInput, "de.taskforce.isphere.messagefileeditor.MessageFileEditor");
