...
public class SearchResult {
	...
	public static SearchResult[] getSearchResults(Connection jdbcConnection, int handle, AS400 as400, String host) {
		...
		try {
			...
			preparedStatementSelect = jdbcConnection.prepareStatement("SELECT * FROM " + ISpherePlugin.getISphereLibrary() + _separator + "XFNDSTRO WHERE XOHDL = ? ORDER BY XOLIB, XOMSGF", ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);
