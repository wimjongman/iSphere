		...
		try {
			...
			BindingDirectoryEditorInput editorInput = 
				new BindingDirectoryEditorInput(
						"de.taskforce.isphere.bindingdirectoryeditor.BindingDirectoryEditor",
						as400,
						jdbcConnection,
						host,
						library,
			...
			PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(editorInput, "de.taskforce.isphere.bindingdirectoryeditor.BindingDirectoryEditor");
