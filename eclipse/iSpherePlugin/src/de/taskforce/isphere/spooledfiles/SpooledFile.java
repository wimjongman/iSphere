...
import de.taskforce.isphere.internal.BrowserEditorInput;
		...
		try {
			...
			if (createStreamFile(format)) {
				...
				if (format.equals("*TEXT")) {
					...
					PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().openEditor(editorInput, "de.taskforce.isphere.internal.BrowserEditor");
