...
public class MonitoringAttributes {
    ...
    private IPropertySet getVendorAttributes() {
        ...
        IPropertySet propertySet = queuedMessageSubSystem.getPropertySet(VENDOR_ID);
        if (propertySet == null) {
            propertySet = new PropertySet(VENDOR_ID);
            queuedMessageSubSystem.addPropertySet(propertySet);
        }
