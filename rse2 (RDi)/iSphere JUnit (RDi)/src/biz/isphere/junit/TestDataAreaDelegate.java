...
import biz.isphere.core.dataareaeditor.DataAreaDelegate;
 ...
 * </pre>
 */
public class TestDataAreaDelegate {
    ...
    private static String lgl_type = DataAreaDelegate.LOGICAL;
    ...
    private static String dec_type = DataAreaDelegate.DECIMAL;
    ...
    public void testIllegalAccessOfCharacterDataArea() throws Exception {
        ...
        DataAreaDelegate char_delegate = new DataAreaDelegate(as400, library, char_name);
    ...
    public void testIllegalAccessOfLogicalDataArea() throws Exception {
        ...
        DataAreaDelegate lgl_delegate = new DataAreaDelegate(as400, library, lgl_name);
    ...
    public void testIllegalAccessOfDecimalDataArea() throws Exception {
        ...
        DataAreaDelegate dec_delegate = new DataAreaDelegate(as400, library, dec_name);
    ...
    public void testCharacterDataArea() throws Exception {
        ...
        DataAreaDelegate delegate = new DataAreaDelegate(as400, library, char_name);
    ...
    public void testLogicalDataArea() throws Exception {
        ...
        DataAreaDelegate delegate = new DataAreaDelegate(as400, library, lgl_name);
    ...
    public void testDecimalDataArea() throws Exception {
        ...
        DataAreaDelegate delegate = new DataAreaDelegate(as400, library, dec_name);
