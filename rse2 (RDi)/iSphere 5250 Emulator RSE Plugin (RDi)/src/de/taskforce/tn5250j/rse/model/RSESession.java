...
public class RSESession extends AbstractResource {
	...
	public static RSESession load(SubSystem subSystem, String name){
		Session session = Session.load(TN5250JRSEPlugin.getRSESessionDirectory(subSystem.getSystemProfileName() + "-" + subSystem.getHostAliasName()), subSystem.getSystemProfileName() + "-" + subSystem.getHostAliasName(), name);
		if (session != null) {
